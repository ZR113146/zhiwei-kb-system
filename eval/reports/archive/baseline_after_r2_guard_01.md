...
- no_result_rate: 0.06
- stale_hit_rate: 0.04
- avg_elapsed_ms: 3613.4
- errors: 0

## By Query Type

- clause: recall=1.0 mrr=0.6972 ndcg=0.7707 no_result=0.0 avg_ms=5850.29
- comparison: recall=1.0 mrr=0.7667 ndcg=0.8262 no_result=0.0 avg_ms=8005.31
- parameter: recall=0.0 mrr=0.0 ndcg=0.0 no_result=0.0 avg_ms=5902.44
- standard_code: recall=0.9444 mrr=0.9444 ndcg=0.9444 no_result=0.0 avg_ms=522.66
- standard_name: recall=1.0 mrr=0.8819 ndcg=0.9109 no_result=0.0 avg_ms=2152.11
- technical: recall=0.0 mrr=0.0 ndcg=0.0 no_result=0.1935 avg_ms=3849.81
- version: recall=1.0 mrr=0.9333 ndcg=0.95 no_result=0.0 avg_ms=2570.3
